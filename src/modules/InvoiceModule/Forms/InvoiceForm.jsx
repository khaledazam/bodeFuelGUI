...
export default function InvoiceForm({ subTotal = 0, current = null }) {
  ...
  if (last_invoice_number === undefined) return <></>;
      ...
      <Row gutter={[12, 0]}>
        ...
        <Col className="gutter-row" span={3}>
          <Form.Item
            ...
            rules={[{ required: true }]}
          >
            <Input inputMode="decimal" placeholder="YYYY" autoComplete="off" />
          </Form.Item>
        </Col>
          ...
          <Col className="gutter-row" span={4} offset={15}>
            <Form.Item name="taxRate" rules={[{ required: true }]}>
              <Select
                ...
                options={[]} // Should be populated via SelectAsync or similar if needed
